...
function listEventInfo() {
	...
	try{
		...
		echo "<h3>Name: </h3>" . $result['evt_name'];
		echo "<h3>Description: </h3>" . $result['evt_description'];
		echo "<h3>Date: </h3>" . $result['evt_date'];
		echo "<h3>Contact Phone: </h3>" . $result['evt_contact'];
